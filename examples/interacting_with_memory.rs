...
//!
//! ```shell
//! cargo run --example interacting-with-memory --release --features "cranelift"
//! ```
//!
//! Ready?

use std::mem;
use wasmer::{imports, Bytes, Instance, Module, Pages, Store, TypedFunction};
...
fn main() -> anyhow::Result<()> {
    ...
    let wasm_bytes = include_bytes!("../wasm_files/interacting_with_memory.wasm");
